...
from layers.Embed import DataEmbedding, DataEmbedding_wo_pos, DataEmbedding_inverted
...
class Model(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        enc_out = enc_out.transpose(1, 2)  # [b n D] -> [b D n]
        adaptation.append(torch.einsum('bDn,bDdn->bdn', [enc_out, adapter]))  # [B, d, N]
        enc_out = torch.cat([enc_out] + adaptation, dim=1)  # [B, H', N]
        enc_out = enc_out.transpose(1, 2)  # [b D n] -> [b n D]
        # Local adaptation
